...
| 檔案 | 筆數 | 用途 |
| --- | ---: | --- |
| `data/play_zone/daily_mv.csv` | 460 | MV 推薦 |
| `data/play_zone/daily_fancam.csv` | 353 | 直拍推薦 |
| `data/play_zone/daily_stage.csv` | 27 | 舞台推薦 |
...
| 檔案 | 筆數 | 欄位 |
| --- | ---: | --- |
| `data/play_zone/photo_cards.csv` | 109 | `artist`, `type`, `url` |
